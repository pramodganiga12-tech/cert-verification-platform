...
export const VerificationProcessDiagram: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-8 font-sans">
      ...
      <div className="bg-glass-card border border-glass rounded-3xl p-6 sm:p-8 shadow-2xl glow-violet backdrop-blur-xl space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
          <div>
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-cyan-500/10 border border-cyan-500/20 rounded-full text-cyan-400 text-xs font-bold uppercase tracking-wider mb-2">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Project Methodology & Architecture</span>
            </div>
            <h2 className="text-2xl font-extrabold font-heading text-gradient-cyan tracking-tight">Academic Certificate Verification System</h2>
          ...
          {/* Toggle Switches */}
          <div className="flex items-center p-1 bg-glass-input border border-glass rounded-xl font-mono text-xs shrink-0">
            <button
              onClick={() => setActivePart('ALL')}
              className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                activePart === 'ALL' ? 'btn-futuristic text-white shadow-md' : 'text-slate-400 hover:text-slate-200'
              }`}
            >
              Full Lifecycle
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                activePart === 'ISSUANCE' ? 'btn-futuristic text-white shadow-md' : 'text-slate-400 hover:text-slate-200'
              }`}
            >
              Phase 1: Issuance
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                activePart === 'VERIFICATION' ? 'btn-futuristic text-white shadow-md' : 'text-slate-400 hover:text-slate-200'
              }`}
            >
        ...
        {(activePart === 'ALL' || activePart === 'ISSUANCE') && (
          <div className="space-y-4 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 relative">
              ...
              {/* Step 1 */}
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-cyan-500/50 transition-all">
                <div className="w-12 h-12 rounded-xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform">
                  <GraduationCap className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-[10px] font-mono text-cyan-400 font-bold block">1. DROP BATCH</span>
              ...
              {/* Step 2 */}
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-violet-500/50 transition-all">
                ...
                <div>
                  <span className="text-[10px] font-mono text-violet-400 font-bold block">2. PARSE TEXT</span>
              ...
              {/* Step 3 & 4 */}
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-teal-500/50 transition-all">
              ...
              {/* Step 5 & 6 */}
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-emerald-500/50 transition-all">
              ...
              {/* Step 7, 8 & 9 */}
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-amber-500/50 transition-all">
        ...
        {activePart === 'ALL' && <div className="border-t border-white/10 my-6" />}
          ...
          <div className="space-y-4 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
              ...
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-cyan-500/50 transition-all">
                ...
                <div>
                  <span className="text-[10px] font-mono text-cyan-400 font-bold block">1 &amp; 2. UPLOAD / PARSE</span>
              ...
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-violet-500/50 transition-all">
                ...
                <div>
                  <span className="text-[10px] font-mono text-violet-400 font-bold block">3. RECALCULATE HASH</span>
              ...
              {/* Step 4 & 5 */}
              <div className="bg-glass-card border border-glass rounded-2xl p-4 flex flex-col items-center text-center space-y-3 relative group hover:border-purple-500/50 transition-all">
