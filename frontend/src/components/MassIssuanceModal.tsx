...
export const MassIssuanceModal: React.FC<MassIssuanceModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#05070d]/70 backdrop-blur-xl animate-in fade-in duration-200">
      <div className="w-full max-w-3xl bg-glass-elevated border border-glass-light rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden font-sans max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 bg-glass-card border border-glass rounded-2xl space-y-3 font-sans">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-9 gap-1.5 text-center font-mono text-[9px]">
            <div className="p-1.5 bg-glass-input border border-glass rounded-lg">
        ...
        {batchResult ? (
          <div className="space-y-4">
            <div className="p-4 bg-glass-card border border-glass rounded-2xl grid grid-cols-3 gap-4 text-center font-mono text-xs">
              <div className="p-2 bg-glass-input rounded-xl">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end">
              <button
                onClick={onClose}
                className="px-5 py-2.5 btn-futuristic text-xs rounded-xl"
              >
                Done
              </button>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="p-6 bg-glass-input border-2 border-dashed border-glass hover:border-cyan-500/50 rounded-2xl transition-all text-center relative group">
                <input
                  type="file"
                  multiple
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-glass-input border border-glass focus:border-cyan-500 rounded-xl px-3 py-2.5 text-xs text-slate-100"
                />
              </div>
